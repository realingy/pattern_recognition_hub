%%
function [nw1,nb1,nw2,nb2,te,tr] = trbpm2(w1,b1,f1,w2,b2,p,t,tp)
global figmain fig

global figt1 figt2 figt3 axt1 axt3 ax framen s1 
mesage=['nodes:',num2str(s1),'    learnin rate:',num2str(tp(4)),'  momentum:',num2str(tp(5))];
mes='2-layer BP with momentum';
if nargin ~= 8
