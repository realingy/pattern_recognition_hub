...
function [nw1,nb1,nw2,nb2,nw3,nb3,te,tr] = ...
  trbpm3(w1,b1,f1,w2,b2,f2,w3,b3,f3,p,t,tp)
global figmain fig


global figt1 figt2 figt3 axt1 axt3 ax framen s1 s2
mesage=['1st layer:',num2str(s1),'  2nd layer:',num2str(s2),'  learnin rate:',num2str(tp(4)),'   momentum:',num2str(tp(5))];
mes='3-layer BP with momentum';
if nargin ~= 12
