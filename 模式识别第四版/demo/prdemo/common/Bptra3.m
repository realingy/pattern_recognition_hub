%%
function [nw,nb,te,tr,ep,er]=bptra3(metrisis,max_epoch,err_goal,lr,lr_inc,lr_dec,err_ratio);
...
[nw,nb,te,tr,ep,er]=trbpa3(wt1,bt1,'logsig',wt2,bt2,'logsig',wt3,bt3,'logsig',metrisis,t,tp);
