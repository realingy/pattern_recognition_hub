%%
function [nw1,nb1,nw2,nb2,nw3,nb3,a,tr]=bptrx3(metrisis,max_epoch,err_goal,lr,lr_inc,lr_dec,mom_const,err_ratio);
...
[nw1,nb1,nw2,nb2,nw3,nb3,a,tr]=trbpx3(wt1,bt1,'logsig',wt2,bt2,'logsig',wt3,bt3,'logsig',metrisis,t,tp);
