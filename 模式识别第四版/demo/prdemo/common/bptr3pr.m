%%
function [nw1,nb1,nw2,nb2,nw3,nb3]=bptr3pr(metrisis,max_epoch,err_goal,lr);
...
tp=[100,max_epoch,err_goal,lr];
[nw1,nb1,nw2,nb2,nw3,nb3,te,tr]=trbp3pr(wt1,bt1,'logsig',wt2,bt2,'logsig',wt3,bt3,'logsig',metrisis,t,tp);
