%%
function [nw1,nb1,nw2,nb2,te,tr] = trbpa2(w1,b1,f1,w2,b2,p,t,tp)
global figmain fig

global figt1 figt2 figt3 axt1 axt3 ax framen s1 
tp5=(tp(5)-1)*100;
tp6=(1-tp(6))*100;
mesage=['nodes:',num2str(s1),'    learnin rate:',num2str(tp(4)),'    lr_inc:',num2str(tp5),'%','    lr_dec:',num2str(tp6),'%'];
mes='2-layer adaptive BP ';
if nargin ~= 8
